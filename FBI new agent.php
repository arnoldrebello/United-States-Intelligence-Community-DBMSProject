...
<head>
    ...
    <body>
	<div align="center">
<form method="POST" action="FBIai.php"  >
 ...
 <input type="text" placeholder="Branch" align="center" name="Branch"><br/><p></p>
 <input type="text" placeholder="Missions" align="center" name="Missions"><br/><p></p>
 <input type="text" placeholder="Specialised Weapons" align="center" name="specialisedweapons"><br/><p></p>
